...
- The docker folder of the installation contains the file: example.env.docker. Rename this file to **.env.docker** and start your editor (N.B. name starts with a dot!)
